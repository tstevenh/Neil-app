  ...
  return (
    <main className="min-h-screen bg-[#f3fbfd] p-8 text-slate-900">
      <div className={`mx-auto mt-16 max-w-md space-y-4 p-8 ${cardClass}`}>
        ...
        <h1 className="text-4xl font-medium text-[#101828]">Sign Up</h1>
        <p className="text-sm text-[#5a6a74]">Create your account to start running QA checks.</p>
        <input
        ...
        />
        <button type="button" className={primaryButtonClass} onClick={signUp} disabled={loading}>
